...
**此开发分支另含 Agent workspace 节点归属文件系统候选。** 它从 `main` 独立开发，保留下面的 v0.1.0 KV 说明和旧服务能力，不把测试候选写成已发布产品。新方向先看 [架构原则](PRINCIPLES.md)、[专题设计](docs/agent-home-preview-design.md)、[阶段验收与性能证据](docs/reviews/agent-home-preview-stage-review.md)和[源码构包/安装说明](docs/agent-home-preview-installation.md)；候选入口是 `server/homefs/` 和 `scripts/homefs/`。
